      ...
      <v-card-text>
        <v-container grid-list-md>
          <v-layout wrap>
            ...
            <v-flex xs12>
              <v-text-field v-model="password" :rules="inputRules" label="Password*" required :append-icon="show ? 'visibility' : 'visibility_off'" :type="show ? 'text' : 'password'" @click:append="show = !show"></v-text-field>
            </v-flex>
