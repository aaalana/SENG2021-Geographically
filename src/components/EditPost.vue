    ...
    <v-dialog persistent no-click-animation max width="100%" v-model="dialog">
        <v-btn flat fab slot="activator"><v-icon>edit</v-icon></v-btn>
            ...
            <v-card max width="50%" class="px-5">
                ...
                <v-card-text>
                    <v-form ref="form">
                        <v-text-field counter="20" label="Title" v-model="editedTitle" prepend-icon="folder" :rules="[rules.empty, rules.max2]"></v-text-field><br>
                        <!--<v-textarea label="Tell us about your trip" v-model="editedContent" prepend-icon="edit" :rules="rules.empty"></v-textarea>-->
