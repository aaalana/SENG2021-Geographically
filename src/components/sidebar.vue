  ...
  >
    <v-toolbar flat class="transparent">
      <v-list class="pa-0">
        <v-list-tile avatar>
          ...
          <v-list-tile-content>
            <v-list-tile-title style="font-family:Quicksand; font-size:20px;">Geographically</v-list-tile-title>
          </v-list-tile-content>
    ...
    <v-list class="pt-0">
      ...
      >
        ...
        <v-list-tile-content>
          <v-list-tile-title style="font-family:Quicksand; font-size:15px;">{{ item.title }}</v-list-tile-title>
        </v-list-tile-content>
